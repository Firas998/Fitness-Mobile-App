...
!(function (t, e) {
  ...
  class pt extends R {
    ...
    _getConfig(t) {
      if (
        ((t = { ...this.constructor.Default, ...K.getDataAttributes(this._element), ...t }), c("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !a(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
      )
